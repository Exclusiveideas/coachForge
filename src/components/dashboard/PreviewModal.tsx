  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4">
      <div className="relative w-full max-w-[672px]">
        ...
        <div className="bg-white rounded-2xl overflow-hidden border border-black/10 shadow-2xl flex flex-col h-[600px]">
          {/* Header */}
          <div className="p-4 border-b border-black/10 flex items-center gap-3">
            <div className="w-10 h-10 bg-accent-orange/15 rounded-xl flex items-center justify-center text-lg">
              {coach.emoji}
            </div>
            <div className="flex-1">
              ...
              <p className="text-black/50 text-xs">AI Coach · {coach.tone}</p>
            </div>
                  ...
                  <div
                    className={`max-w-[80%] px-4 py-2.5 rounded-2xl text-sm leading-relaxed ${
                      msg.role === "user"
                        ...
                        : "bg-black/5 text-[#1a1a1a] rounded-bl-sm"
                    }`}
                  >
                    {msg.role === "assistant" ? (
          ...
          <div className="p-3 border-t border-black/10">
            <form onSubmit={handleSend} className="flex gap-2">
              <input
                ...
                className="flex-1 bg-black/[0.03] border border-black/15 rounded-xl px-4 py-2.5 text-[#1a1a1a] text-sm placeholder-black/40 focus:outline-none focus:border-accent-orange/50"
